    ...
    <div className="w-full">
        ...
        <div className="container mx-auto px-6 max-w-7xl relative z-10 py-12 md:py-24">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center">
            ...
            >
              ...
              >
                <img 
                  src="/images/full_face_carbon_helmet_1786813061790.jpg" 
      ...
      <section className="py-24 bg-[#0a0a0a] border-y border-white/5">
        <div className="container mx-auto px-6 max-w-7xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-16">
            {[
              { title: 'FULL FACE', desc: 'Maximum protection for track and street.', img: '/images/full_face_carbon_helmet_1786813061790.jpg' },
              { title: 'MODULAR', desc: 'Versatility for touring and commuting.', img: '/images/modular_touring_helmet_1786813075868.jpg' },
              { title: 'OPEN FACE', desc: 'Classic freedom for urban rides.', img: '/images/open_face_retro_helmet_1786813090289.jpg' },
            ].map((cat, i) => (
      ...
      <section className="py-32 relative overflow-hidden flex items-center justify-center">
        <div className="absolute inset-0 z-0">
          ...
          <img 
            src="/images/rider_action_1786815787314.jpg" 
            alt="Riding" 
